  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1">
        {/* Hero Section */}
        <section className="w-full py-12 md:py-24 lg:py-32 bg-[url('/images/homeImage.jpg')] bg-cover bg-center bg-no-repeat">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2 drop-shadow-2xl">
                <h1 className="text-3xl font-bold text-violet-50 sm:text-4xl md:text-5xl lg:text-6xl" style={{ textShadow: "2px 2px 4px black" }}>
                  Find the Best Hotel Deals
                </h1>
                <p className="mx-auto max-w-[700px] text-gray-200 md:text-xl" style={{ textShadow: "2px 1px 1px black" }}>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-gray-900">Popular Destinations</h2>
            ...
            <div className="mx-auto grid max-w-5xl grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-8">
              {[
                { name: "New York", image: "/images/newyork.jpg", hotels: 1243 },
                    ...
                    <CardContent className="p-4">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-sm text-gray-600">{destination.hotels} hotels</p>
                        </div>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-gray-100">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-gray-900">Why Choose Us</h2>
              <p className="max-w-[900px] text-gray-700 md:text-xl">
            ...
            <div className="mx-auto grid max-w-5xl grid-cols-1 md:grid-cols-3 gap-8 mt-8">
              {[
                { title: "Best Price Guarantee", icon: <Star className="h-6 w-6 text-blue-600" /> },
                { title: "No Booking Fees", icon: <Users className="h-6 w-6 text-blue-600" /> },
                { title: "Millions of Reviews", icon: <MapPin className="h-6 w-6 text-blue-600" /> },
              ].map((feature, index) => (
                <Card key={index} className="bg-white">
                  <CardContent className="p-6 flex flex-col items-center text-center">
                    ...
                    <p className="text-gray-600">We ensure you get the best deals with no hidden fees.</p>
                  </CardContent>
                </Card>
              ))}
            </div>
